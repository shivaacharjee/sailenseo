...
function rich_snippet_dashboard() {
	...
	echo '<ul class="etabs">
		 ...
		 <div class="clear"></div>
		 <div class="panel-container sailen-panel">
			 <div id="tab-1">
				<div id="poststuff">
							...
							<div class="postbox closed">
								...
								<div class="inside">
									<div class="table">
										...
										<form id="sailen_review_form" method="post">
											<table class="sailen_metabox">
												<tbody>
													<tr>
														<td align="right"><strong><label>'.__("Rich Snippet Title :","rich-snippets").'</label></strong></td>
														<td><input class="sailen_text_medium" type="text" name="review_title" value="'.$args_review["review_title"].'"/></td>
													</tr>
													<tr>
														<td align="right"><strong><label>'.__("Reviewer :","rich-snippets").'</label></strong></td>
														<td><input class="sailen_text_medium" type="text" name="item_reviewer" value="'.$args_review["item_reviewer"].'"/></td>
													</tr>
													<tr>
														<td align="right"><strong><label>'.__("Review Date :","rich-snippets").'</label></strong></td>
														<td><input class="sailen_text_medium" type="text" name="review_date" value="'.$args_review["review_date"].'"/></td>
													</tr>
													<tr>
														<td align="right"><strong><label>'.__("Item Name :","rich-snippets").'</label></strong></td>
														<td><input class="sailen_text_medium" type="text" name="item_name" value="'.$args_review["item_name"].'"/></td>
													</tr>
													<tr>
														<td align="right"><strong><label>'.__("Item Ratings :","rich-snippets").'</label></strong></td>
														<td><input class="sailen_text_medium" type="text" name="item_rating" value="'.$args_review["item_rating"].'"/></td>
													</tr>
							...
							<div class="postbox closed">
								...
								<div class="inside">
									<div class="table">
										...
										<form id="sailen_event_form" method="post">
											<table class="sailen_metabox">
												<tbody>
													<tr>
														<td align="right"><strong><label>'.__("Rich Snippet Title :","rich-snippets").'</label></strong></td>
														<td><input class="sailen_text_medium" type="text" name="snippet_title" value="'.$args_event["snippet_title"].'"/></td>
													</tr>
													<tr>
														<td align="right"><strong><label>'.__("Event Title :","rich-snippets").'</label></strong></td>
														<td><input class="sailen_text_medium" type="text" name="event_title" value="'.$args_event["event_title"].'"/></td>
													</tr>
													<tr>
														<td align="right"><strong><label>'.__("Event Location :","rich-snippets").'</label></strong></td>
														<td><input class="sailen_text_medium" type="text" name="event_location" value="'.$args_event["event_location"].'"/></td>
													</tr>
													<tr>
														<td align="right"><strong><label>'.__("Start Time :","rich-snippets").'</label></strong></td>
														<td><input class="sailen_text_medium" type="text" name="start_time" value="'.$args_event["start_time"].'"/></td>
													</tr>
													<tr>
														<td align="right"><strong><label>'.__("End Time :","rich-snippets").'</label></strong></td>
														<td><input class="sailen_text_medium" type="text" name="end_time" value="'.$args_event["end_time"].'"/></td>
													</tr>
													<tr>
														<td align="right"><strong><label>'.__("Ticket Promotion :","rich-snippets").'</label></strong></td>
														<td><input class="sailen_text_medium" type="text" name="events_price" value="'.$args_event["events_price"].'"/></td>
													</tr>
													<tr><td colspan="2"></td></tr>
													<tr>
														<td></td>
							...
							<div class="postbox closed">
								...
								<div class="inside">
									<div class="table">								
										...
										<form id="sailen_person_form" method="post">
											<table class="sailen_metabox">
												<tbody>
													<tr>
														<td align="right"><strong><label>'.__("Rich Snippet Title :","rich-snippets").'</label></strong></td>
														<td><input class="sailen_text_medium" type="text" name="snippet_title" value="'.$args_person["snippet_title"].'"/></td>
													</tr>
													<tr>
														<td align="right"><strong><label>'.__("Person's Name :","rich-snippets").'</label></strong></td>
														<td><input class="sailen_text_medium" type="text" name="person_name" value="'.$args_person["person_name"].'"/></td>
													</tr>
													<tr>
														<td align="right"><strong><label>'.__("Nickname :","rich-snippets").'</label></strong></td>
														<td><input class="sailen_text_medium" type="text" name="person_nickname" value="'.$args_person["person_nickname"].'"/></td>
													</tr>
													<tr>
														<td align="right"><strong><label>'.__("Job Title :","rich-snippets").'</label></strong></td>
														<td><input class="sailen_text_medium" type="text" name="person_job_title" value="'.$args_person["person_job_title"].'"/></td>
													</tr>
													<tr>
														<td align="right"><strong><label>'.__("Homepage :","rich-snippets").'</label></strong></td>
														<td><input class="sailen_text_medium" type="text" name="person_website" value="'.$args_person["person_website"].'"/></td>
													</tr>
													<tr>
														<td align="right"><strong><label>'.__("Company Name :","rich-snippets").'</label></strong></td>
														<td><input class="sailen_text_medium" type="text" name="person_company" value="'.$args_person["person_company"].'"/></td>
													</tr>
													<tr>
														<td align="right"><strong><label>'.__("Address :","rich-snippets").'</label></strong></td>
														<td><input class="sailen_text_medium" type="text" name="person_address" value="'.$args_person["person_address"].'"/></td>
													</tr>
													<tr><td colspan="2"></td></tr>
													<tr>
														<td></td>
							...
							<div class="postbox closed">
								...
								<div class="inside">
									<div class="table">								
										...
										<form id="sailen_product_form" method="post">
											<table class="sailen_metabox">
												<tbody>
													<tr>
														<td align="right"><strong><label>'.__("Rich Snippet Title :","rich-snippets").'</label></strong></td>
														<td><input class="sailen_text_medium" type="text" name="snippet_title" value="'.$args_product["snippet_title"].'"/></td>
													</tr>
													<tr>
														<td align="right"><strong><label>'.__("Author Rating :","rich-snippets").'</label></strong></td>
														<td><input class="sailen_text_medium" type="text" name="product_rating" value="'.$args_product["product_rating"].'"/></td>
													</tr>
													<tr>
														<td align="right"><strong><label>'.__("Brand Name :","rich-snippets").'</label></strong></td>
														<td><input class="sailen_text_medium" type="text" name="product_brand" value="'.$args_product["product_brand"].'"/></td>
													</tr>
													<tr>
														<td align="right"><strong><label>'.__("Product Name :","rich-snippets").'</label></strong></td>
														<td><input class="sailen_text_medium" type="text" name="product_name" value="'.$args_product["product_name"].'"/></td>
													</tr>
													<tr>
														<td align="right"><strong><label>'.__("User Rating :","rich-snippets").'</label></strong></td>
														<td><input class="sailen_text_medium" type="text" name="product_agr" value="'.$args_product["product_agr"].'"/></td>
													</tr>
													<tr>
														<td align="right"><strong><label>'.__("Price :","rich-snippets").'</label></strong></td>
														<td><input class="sailen_text_medium" type="text" name="product_price" value="'.$args_product["product_price"].'"/></td>
													</tr>
													<tr>
														<td align="right"><strong><label>'.__("Product Availability :","rich-snippets").'</label></strong></td>
														<td><input class="sailen_text_medium" type="text" name="product_avail" value="'.$args_product["product_avail"].'"/></td>
													</tr>
													<tr><td colspan="2"></td></tr>
													<tr>
														<td></td>
							...
							<div class="postbox closed">
								...
								<div class="inside">
									<div class="table">								
										...
										<form id="sailen_recipe_form" method="post">
											<table class="sailen_metabox">
												<tbody>
													<tr>
														<td align="right"><strong><label>'.__("Rich Snippet Title :","rich-snippets").'</label></strong></td>
														<td><input class="sailen_text_medium" type="text" name="snippet_title" value="'.$args_recipe["snippet_title"].'"/></td>
													</tr>
													<tr>
														<td align="right"><strong><label>'.__("Recipe Name :","rich-snippets").'</label></strong></td>
														<td><input class="sailen_text_medium" type="text" name="recipe_name" value="'.$args_recipe["recipe_name"].'"/></td>
													</tr>
													<tr>
														<td align="right"><strong><label>'.__("Published On : ","rich-snippets").'</label></strong></td>
														<td><input class="sailen_text_medium" type="text" name="recipe_pub" value="'.$args_recipe["recipe_pub"].'"/></td>
													</tr>
													<tr>
														<td align="right"><strong><label>'.__("Preparation Time:","rich-snippets").'</label></strong></td>
														<td><input class="sailen_text_medium" type="text" name="recipe_prep" value="'.$args_recipe["recipe_prep"].'"/></td>
													</tr>
													<tr>
														<td align="right"><strong><label>'.__("Cook Time :","rich-snippets").'</label></strong></td>
														<td><input class="sailen_text_medium" type="text" name="recipe_cook" value="'.$args_recipe["recipe_cook"].'"/></td>
													</tr>
													<tr>
														<td align="right"><strong><label>'.__("Total Time :","rich-snippets").'</label></strong></td>
														<td><input class="sailen_text_medium" type="text" name="recipe_time" value="'.$args_recipe["recipe_time"].'"/></td>
													</tr>
													<tr>
														<td align="right"><strong><label>'.__("Average Rating:","rich-snippets").'</label></strong></td>
														<td><input class="sailen_text_medium" type="text" name="recipe_rating" value="'.$args_recipe["recipe_rating"].'"/></td>
													</tr>
													<tr><td colspan="2"></td></tr>
													<tr>
														<td></td>
							...
							<div class="postbox closed">
								...
								<div class="inside">
									<div class="table">								
										...
										<form id="sailen_software_form" method="post">
											<table class="sailen_metabox">
												<tbody>
													<tr>
														<td align="right"><strong><label>'.__("Rich Snippet Title :","rich-snippets").'</label></strong></td>
														<td><input class="sailen_text_medium" type="text" name="snippet_title" value="'.$args_soft["snippet_title"].'"/></td>
													</tr>
													<tr>
														<td align="right"><strong><label>'.__("Author Rating :","rich-snippets").'</label></strong></td>
														<td><input class="sailen_text_medium" type="text" name="software_rating" value="'.$args_soft["software_rating"].'"/></td>
													</tr>
													<tr>
														<td align="right"><strong><label>'.__("User Rating :","rich-snippets").'</label></strong></td>
														<td><input class="sailen_text_medium" type="text" name="software_agr" value="'.$args_soft["software_agr"].'"/></td>
													</tr>
													<tr>
														<td align="right"><strong><label>'.__("Software Price :","rich-snippets").'</label></strong></td>
														<td><input class="sailen_text_medium" type="text" name="software_price" value="'.$args_soft["software_price"].'"/></td>
													</tr>
													<tr>
														<td align="right"><strong><label>'.__("Software Name:","rich-snippets").'</label></strong></td>
														<td><input class="sailen_text_medium" type="text" name="software_name" value="'.$args_soft["software_name"].'"/></td>
													</tr>
													<tr>
														<td align="right"><strong><label>'.__("Operating System :","rich-snippets").'</label></strong></td>
														<td><input class="sailen_text_medium" type="text" name="software_os" value="'.$args_soft["software_os"].'"/></td>
													</tr>
													<tr>
														<td align="right"><strong><label>'.__("Landing Page:","rich-snippets").'</label></strong></td>
														<td><input class="sailen_text_medium" type="text" name="software_website" value="'.$args_soft["software_website"].'"/></td>
													</tr>
													<tr><td colspan="2"></td></tr>
													<tr>
														<td></td>
							...
							<div class="postbox closed">
								...
								<div class="inside">
									<div class="table">								
										...
										<form id="sailen_video_form" method="post">
											<table class="sailen_metabox">
												<tbody>
													<tr>
														<td align="right"><strong><label>'.__("Rich Snippet Title :","rich-snippets").'</label></strong></td>
														<td><input class="sailen_text_medium" type="text" name="snippet_title" value="'.$args_video["snippet_title"].'"/></td>
													</tr>
													<tr>
														<td align="right"><strong><label>'.__("Video Title :","rich-snippets").'</label></strong></td>
														<td><input class="sailen_text_medium" type="text" name="video_title" value="'.$args_video["video_title"].'"/></td>
													</tr>
													<tr>
														<td align="right"><strong><label>'.__("Description :","rich-snippets").'</label></strong></td>
														<td><input class="sailen_text_medium" type="text" name="video_desc" value="'.$args_video["video_desc"].'"/></td>
													</tr>
													<tr>
														<td align="right"><strong><label>'.__("Video Duration :","rich-snippets").'</label></strong></td>
														<td><input class="sailen_text_medium" type="text" name="video_time" value="'.$args_video["video_time"].'"/></td>
													</tr>													
													<tr>
														<td align="right"><strong><label>'.__("Video Upload Date :","rich-snippets").'</label></strong></td>
														<td><input class="sailen_text_medium" type="text" name="video_date" value="'.$args_video["video_date"].'"/></td>
													</tr>
													<tr><td colspan="2"></td></tr>
													<tr>
														<td></td>
							...
							<div class="postbox closed">
								...
								<div class="inside">
									<div class="table">								
										...
										<form id="sailen_article_form" method="post">
											<table class="sailen_metabox">
												<tbody>
													<tr>
														<td align="right"><strong><label>'.__("Rich Snippet Title :","rich-snippets").'</label></strong></td>
														<td><input class="sailen_text_medium" type="text" name="snippet_title" value="'.$args_article["snippet_title"].'"/></td>
													</tr>
													<tr>
														<td align="right"><strong><label>'.__("Article Name :","rich-snippets").'</label></strong></td>
														<td><input class="sailen_text_medium" type="text" name="article_name" value="'.$args_article["article_name"].'"/></td>
													</tr>
													<tr>
														<td align="right"><strong><label>'.__("Author :","rich-snippets").'</label></strong></td>
														<td><input class="sailen_text_medium" type="text" name="article_author" value="'.$args_article["article_author"].'"/></td>
													</tr>
													<tr>
														<td align="right"><strong><label>'.__("Description :","rich-snippets").'</label></strong></td>
														<td><input class="sailen_text_medium" type="text" name="article_desc" value="'.$args_article["article_desc"].'"/></td>
													</tr>
													<tr>
														<td align="right"><strong><label>'.__("Image :","rich-snippets").'</label></strong></td>
														<td><input class="sailen_text_medium" type="text" name="article_image" value="'.$args_article["article_image"].'"/></td>
													</tr>
													<tr>
														<td align="right"><strong><label>'.__("Publisher :","rich-snippets").'</label></strong></td>
														<td><input class="sailen_text_medium" type="text" name="article_publisher" value="'.$args_article["article_publisher"].'"/></td>
													</tr>
													<tr>
														<td align="right"><strong><label>'.__("Publisher Logo :","rich-snippets").'</label></strong></td>
														<td><input class="sailen_text_medium" type="text" name="article_publisher_logo" value="'.$args_article["article_publisher_logo"].'"/></td>
													</tr>
													<tr><td colspan="2"></td></tr>
													<tr>
														<td></td>
							...
							<div class="postbox closed">
								...
								<div class="inside">
									<div class="table">								
										...
										<form id="sailen_service_form" method="post">
											<table class="sailen_metabox">
												<tbody>
													<tr>
														<td align="right"><strong><label>'.__("Rich Snippet Title :","rich-snippets").'</label></strong></td>
														<td><input class="sailen_text_medium" type="text" name="snippet_title" value="'.$args_service["snippet_title"].'"/></td>
													</tr>
													<tr>
														<td align="right"><strong><label>'.__("Service Type :","rich-snippets").'</label></strong></td>
														<td><input class="sailen_text_medium" type="text" name="service_type" value="'.$args_service["service_type"].'"/></td>
													</tr>
													<tr>
														<td align="right"><strong><label>'.__("Area :","rich-snippets").'</label></strong></td>
														<td><input class="sailen_text_medium" type="text" name="service_area" value="'.$args_service["service_area"].'"/></td>
													</tr>
													<tr>
														<td align="right"><strong><label>'.__("Description :","rich-snippets").'</label></strong></td>
														<td><input class="sailen_text_medium" type="text" name="service_desc" value="'.$args_service["service_desc"].'"/></td>
													</tr>
													<tr>
														<td align="right"><strong><label>'.__("Provider Name :","rich-snippets").'</label></strong></td>
														<td><input class="sailen_text_medium" type="text" name="service_provider_name" value="'.$args_service["service_provider_name"].'"/></td>
													</tr>
													<tr>
														<td align="right"><strong><label>'.__("URL :","rich-snippets").'</label></strong></td>
														<td><input class="sailen_text_medium" type="text" name="service_channel" value="'.$args_service["service_channel"].'"/></td>
													</tr>
													<tr>
														<td align="right"><strong><label>'.__("URL Text :","rich-snippets").'</label></strong></td>
														<td><input class="sailen_text_medium" type="text" name="service_url_link" value="'.$args_service["service_url_link"].'"/></td>
													</tr>
													<tr>
														<td align="right"><strong><label>'.__("Service Rating :","rich-snippets").'</label></strong></td>
														<td><input class="sailen_text_medium" type="text" name="service_rating" value="'.$args_service["service_rating"].'"/></td>
													</tr>
													<tr><td colspan="2"></td></tr>
													<tr>
														<td></td>
							...
							<div class="meta-box-sortables ui-sortable">
								<div class="postbox">
									<div class="handlediv" title="Click to toggle"><br></div>
										...
										<div class="inside">
											<form id="sailen_css_editor" method="post" onsubmit="return false;" action="">
											<table class="sailen_metabox">
												<tr>
...
if(isset($_GET['action']))
{
	if($_GET['action'] == 'reset')
	{
		...
		if($option_to_reset == 'review')
			delete_option('sailen_review');
		if($option_to_reset == 'event')
			delete_option('sailen_event');
		if($option_to_reset == 'person')			
			delete_option('sailen_person');
			
		if($option_to_reset == 'product')
			delete_option('sailen_product');
		if($option_to_reset == 'recipe')			
			delete_option('sailen_recipe');
		if($option_to_reset == 'software')			
			delete_option('sailen_software');
		if($option_to_reset == 'video')
			delete_option('sailen_video');
		
		if($option_to_reset == 'article')
			delete_option('sailen_article');
		if($option_to_reset == 'service')
			delete_option('sailen_service');
		
		if($option_to_reset == 'color')
			delete_option('sailen_custom');
		
		sailen_reset_options($option_to_reset);
	}
}
function sailen_reset_options($option_to_reset)
{
...
{?>
	<script type="text/javascript">
        ...
        {
            var data = jQuery("#sailen_css_editor").serialize();
            var form_data = "action=sailen_submit_color&" + data;
          //alert(form_data);
	   ...
	   jQuery("#support_form").submit(function()
        {
            ...
            var form_data = "action=sailen_submit_request&" + data;
         // alert(form_data);
            jQuery.post(ajaxurl, form_data,
                function (response) {
                    alert(response);
					jQuery("#support_form .sailen_text_medium, #support_form .sailen_textarea_small").val("");
                }
            );
        });
    </script>
...
{
	$html = '
		<div class="postbox sailen-contact" style=" width: 36%; float: right; ">
			...
			<form name="support" id="support_form" action="" method="post" onsubmit="return false;">
				...
				<table class="sailen_metabox" > <input type="hidden" name="site_url" value="'.site_url().'" /> </p>
					<tr><td><label for="name"><strong>'.__( 'Your Name:', 'rich-snippets').'<span style="color:red;"> *</span></strong> </label></td>
						<td><input required="required" type="text" class="sailen_text_medium" name="name" /></td></tr>
					<tr><td><label for="email"><strong>'.__( 'Your Email:', 'rich-snippets').'<span style="color:red;"> *</span></strong> </label></td>
						<td><input required="required" type="text" class="sailen_text_medium" name="email" /></td></tr>
					<tr><td><label for="post_url"><strong>'.__( 'Reference URL:', 'rich-snippets').'<span style="color:red;"> *</span></strong> </label></td>
						<td><input required="required" type="text" class="sailen_text_medium" name="post_url" /></td></tr>
					...
					<tr><td class="sailen_label"><label for="message"><strong>'.__( 'Your Query in Brief:', 'rich-snippets').'</strong> </label></td>
						<td rowspan="4"><textarea class="sailen_textarea_small" name="message"></textarea> </td></tr>
						<tr></tr> <tr></tr> <tr></tr>
					<tr><td></td>
